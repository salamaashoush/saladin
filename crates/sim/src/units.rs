...
const UNIT_DEFS: [UnitDef; 15] = [
    ...
    UnitDef {
        ...
        range: crate::fx!("1.2"),
        cost: ResourceCost::new(10, 0, 30, 0),
        tint: Some(0x3a3a3a),
    ...
    UnitDef {
        ...
        cost: ResourceCost::new(8, 0, 24, 0),
        tint: Some(0x5a3a1a),
    ...
    UnitDef {
        ...
        attack_ticks: 6,
        aggro_range: crate::fx!("7"),
        cost: ResourceCost::new(13, 0, 42, 35),
        tint: Some(0x9a8050),
    ...
    UnitDef {
        ...
        cost: ResourceCost::new(9, 0, 26, 15),
        tint: Some(0x7a5a2a),
        requires: Some(BuildingKind::Stable),
        morale_resolve: crate::fx!("0.9"),
        ranged: true,
    ...
    UnitDef {
        ...
        attack_ticks: 10,
        aggro_range: crate::fx!("7"),
        cost: ResourceCost::new(10, 0, 30, 12),
        tint: Some(0x4a3a2a),
    ...
    UnitDef {
        ...
        armor_class: ArmorClass::Mail,
        range: crate::fx!("1.1"),
        cost: ResourceCost::new(12, 0, 36, 17),
        tint: Some(0x7a7f8a),
    ...
    UnitDef {
        ...
        attack_ticks: 8,
        cost: ResourceCost::new(8, 0, 24, 23),
        tint: Some(0xb4552a),
        requires: Some(BuildingKind::Blacksmith),
        morale_resolve: crate::fx!("0.8"),
        splash: crate::fx!("1.2"),
